...
use Laucov\Validation\Rules\DoesNotMatch;
use Tests\RuleTestCase;

/**
 * @coversDefaultClass \Laucov\Validation\Rules\DoesNotMatch
 */
class DoesNotMatchTest extends RuleTestCase
{
    /**
    ...
    public function testCanValidate(
        ...
        $rule = new DoesNotMatch(...$arguments);
        $rule->setData($data);
    ...
    {
        $this->assertIsPropertyAttribute(DoesNotMatch::class, true);
    }
